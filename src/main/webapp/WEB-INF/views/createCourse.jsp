...
<div class="div-form">
    <form:form id ="newCourseForm" modellAttribute ="createCourseForm" action = "createCourseProcess" method = "post">
        <div class="container">
            ...
            <input type="text" placeholder="Enter number of units" name="units" required>
